	...
	try {
		...
		const serviceTierByFamily = command.flags.serviceTier
			...
			: buildServiceTierByFamily(
					(runtime.settings ? cfgTierOpenai.get(runtime.settings) : undefined) ?? "provider",
					(runtime.settings ? cfgTierAnthropic.get(runtime.settings) : undefined) ?? "provider",
					(runtime.settings ? cfgTierGoogle.get(runtime.settings) : undefined) ?? "provider",
				);
