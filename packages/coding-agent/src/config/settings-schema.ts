...
export const SETTINGS_SCHEMA = {
	...
	"providers.fetch": {
		type: "enum",
		values: ["auto", "native", "trafilatura", "lynx", "parallel", "keenable", "firecrawl", "jina"] as const,
		default: "auto",
		ui: {
			tab: "providers",
			group: "Services",
			...
			options: [
				{
					value: "auto",
					label: "Auto",
					description: "Priority: native > trafilatura > lynx > parallel > keenable > firecrawl > jina",
				},
