...
export const SETTINGS_SCHEMA = {
	...
	"providers.autoThinkingModel": {
		...
		ui: {
			...
			description:
				"Difficulty classifier for the `auto` thinking level: online (the TINY role from /models, else smol) by default, a local on-device model, or TypeSafe (Jev) typed judgments",
	...
	"providers.unexpectedStopModel": {
		...
		ui: {
			...
			description:
				"Classifier for Smart unexpected-stop detection: online (the TINY role from /models, else smol) by default, a local on-device model, or TypeSafe (Jev) typed judgments.",
	...
	"providers.fetch": {
		type: "enum",
		values: ["auto", "native", "trafilatura", "lynx", "parallel", "firecrawl", "keenable", "jina"] as const,
		default: "auto",
		ui: {
			tab: "providers",
			group: "Services",
			...
			options: [
				{
					value: "auto",
					label: "Auto",
					description: "Priority: native > trafilatura > lynx > parallel > firecrawl > keenable > jina",
				},
				...
				{ value: "firecrawl", label: "Firecrawl", description: "Requires FIRECRAWL_API_KEY" },
				{
					value: "keenable",
					label: "Keenable",
					description: "Requires KEENABLE_API_KEY; explicit selection uses public fetch",
				},
